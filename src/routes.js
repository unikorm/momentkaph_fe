...
// Eager imports above: the app is small enough that per-route dynamic import()
// would only add a loading-state UI requirement without a meaningful payload
// win. Revisit if the app grows.
